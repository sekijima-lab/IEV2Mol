...
for i in tqdm(range(100)):
    ...
    with open(f"./chembl_smi/chembl33_random100_{i}.smi", "w") as f:
...
for i, (inp_smi, inp_vec) in enumerate(test_dataset):
    ...
    subprocess.run(["cp", f"./chembl_smi/chembl33_random100_{i}.smi", "out_smiles.smi"])
    ...
    df.to_csv(f"../results/{protein}/test{i}/raw_csv/random_chembl33.csv")
